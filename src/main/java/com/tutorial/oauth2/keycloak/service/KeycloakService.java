package com.tutorial.oauth2.keycloak.service;
    ...
    public Object[] createUser(User user){
        ...
        try{
            ...
            if(statusId==201){
                ...
                message.setMessage("Usuario creado con exito");

            }else if(statusId==409){
                message.setMessage("Usuario ya existe");
            }else{
                message.setMessage("Error creado el usuario");
            }
